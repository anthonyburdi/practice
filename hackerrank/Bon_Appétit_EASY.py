...
def bonAppetit(bill, k, b):
    ...
    # Assumptions
    # input and output in integers
    # no negative input
    # if anna owes brian money then print Bon Appetit

    # Approach, complexity, tradeoffs, improvements
    # Calculate how much anna owes and compare to what she paid
    # O(N) time complexity where N is the number of items on the bill
    # O(1) space complexity

    # Edge Cases
    # No items on the bill (not incl bc of constraints)
    # None that are not included in constraints or assumptions
    ...
    fair_anna_contribution = anna_bill // 2
    if fair_anna_contribution < b:
        print(b - fair_anna_contribution)
    else:
        print("Bon Appetit")
